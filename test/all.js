var tud = require('../').init({
    nodeAsyncCallLog : true, userAsyncCallLog : true,
    nodeStackViewLvl : 'off', userStackViewLvl : { asyncCall: 'all', debugCall: 'app' }
});
...
tud.injectTest(function(){
    ...
    __(path.relative('/home/prj/doitnodejs/build', '/home/prj/doitnodejs/build/tud.js'));
    __(path.relative('/home/prj/doitnodejs/build/', '/home/prj/doitnodejs/build/tud.js'));
    __(path.relative('/home/prj/doitnodejs/build/', '/home/prj/doitnodejs/zzz/tud.js'));
    __(path.relative('/home/prj/doitnodejs/build/', './tud.js'));
});

tud.injectTest(function(){
    __( path.normalize('/home/prj/doitnodejs/build'),
        path.normalize('/home/prj/doitnodejs/build/'),
        path.normalize('/home/prj/doitnodejs\\build/'),
        path.normalize('/home/prj/doitnodejs/./build/'),
        path.normalize('/home/prj/doitnodejs/zxc/../build/'),
        path.normalize('/home/prj/doitnodejs/zxc\\../build/')
    );

    __( path.relative('/data/orandea/test/aaa', '/data/orandea/impl/bbb'),
        path.relative('/home/prj/doitnodejs/build', '/home/prj/doitnodejs/build/tud.js'),
        path.relative('/home/prj/doitnodejs/build/', '/home/prj/doitnodejs/build/tud.js'),
        path.relative('/home/prj/doitnodejs/build/', '/home/prj/doitnodejs/zzz/tud.js'),
        path.relative('/home/prj/doitnodejs/build/', './tud.js')
    );
    ...
    __( path.isAbsolute('module.js'),
        ...
        path.isAbsolute('/home/prj/doitnodejs/build/zxc.js'),
        path.isAbsolute('./zxc.js'),
        path.isAbsolute('D:\\workspace\\ws\\doitnodejs\\zxc.js'),
        path.isAbsolute('.\\zxc.js')
    );
});
